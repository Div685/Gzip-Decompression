...
namespace TestDecompression
{
    internal static class StringCompressor
    {
        ...
        public static void Main(string[] args)
        {
            ...
            //string str2 = DecompressString(encodedString);
            //Console.WriteLine(str2);
            byte[] bytesencode = Encoding.UTF8.GetBytes(encodedString);
            byte[] gZipBuffer = Convert.FromBase64String(encodedString);
           // byte[] str2 = DecompressGzip(bytesencode);
           // string deCompressedString = Encoding.UTF8.GetString(str2);
            //public static string DecompressToString1(byte[] input) => Encoding.UTF8.GetString(Decompress(input));
